...
describe('runner enrollment', () => {
  it('builds explicit platform and architecture payloads', () => {
    ...
    expect(enrollmentPayload('runner-1', 'windows', 'amd64', undefined, 10, ' nats://vmnet8:4222 ', ' http://control.example/ ')).toEqual({ runner_name: 'runner-1', platform: 'windows', architecture: 'amd64', capacity: 10, embedded_nats_endpoint: 'nats://vmnet8:4222', control_plane_url: 'http://control.example' })
  })
})
