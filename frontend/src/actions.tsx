...
export function DangerousAction({ label, title = label, warning = dangerousWarning(label), confirmLabel = label, reasonRequired = false, onConfirm, onConflict }: { label: string; title?: string; warning?: string; confirmLabel?: string; reasonRequired?: boolean; onConfirm: (reason?: string) => void | Promise<void>; onConflict?: () => void }) {
