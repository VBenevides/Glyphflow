...
export function runQuery(filters: { task: string; runner: string; state: string; trigger: string; from: string; to: string }, page: number, limit?: number) {
  return { task: filters.task || undefined, runner: filters.runner || undefined, state: filters.state || undefined, trigger: filters.trigger || undefined, from: filters.from || undefined, to: filters.to || undefined, page, ...(limit ? { limit } : {}) }
}
