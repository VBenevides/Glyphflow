...
export function enrollmentPayload(runnerId: string, platform: string, architecture: string, poolId?: string, capacity = 10) {
  return { runner_id: runnerId.trim(), platform: platform.trim(), architecture: architecture.trim(), capacity, ...(poolId ? { pool_id: poolId.trim() } : {}) }
}
