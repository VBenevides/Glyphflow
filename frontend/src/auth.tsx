...
export function AuthProvider({ children }: { children: ReactNode }) {
  const [state, setState] = useState<BootstrapResult>({ config: { brand: 'Glyphflow', passwordLogin: false, registration: false, requireUserApproval: false, oidc: false, csrfCookie: 'glyphflow_csrf', lockdownScheduler: false }, profile: null, permissions: [] })
