...
export type SecretEntry = { name: string; secretId: string }
...
export function TaskEditorPage({ editTaskId, inDialog = false, onClose, onSaved }: TaskEditorProps = {}) {
  ...
  const addSecret = () => setDraft((current) => ({ ...current, secrets: [...current.secrets, { name: '', secretId: '' }] }))
