...
export function GlobalVariablesPage() {
  ...
  const remove = async (item: GlobalVariable) => {
	...
	return <main className="gf-content"><PageHeader title="Global environment variables" description="Reusable non-secret values. Reference them as $ENV:VARIABLE_NAME in supported task and schedule fields." action={manage && !editing && <Button onClick={() => setEditing({ id: '', name: '', value: '' })}>Create variable</Button>} refresh={<QueryRefresh query={query} />} />
