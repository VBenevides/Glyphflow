...
export const PERMISSIONS = [
  ...
  { name: 'secrets.read', privilegeLevel: 'elevated' }, { name: 'secrets.manage', privilegeLevel: 'elevated' },
...
export const ROUTES: RouteRule[] = [
  ...
  { path: '/admin/secrets', label: 'Secrets', access: 'permission', permission: 'secrets.read|secrets.manage' },
