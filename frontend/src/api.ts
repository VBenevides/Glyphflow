...
export type OidcProvider = { id?: string; key: string; name?: string; issuer: string; icon?: string; enabled?: boolean; clientId?: string; clientSecret?: string; groupMapping?: Record<string, string> }
export type SecretAttention = { id: string; name: string; status: string }
export type SecretTaskUsage = { id: string; name: string }
export type SecretMetadata = { id: string; name: string; status: string; createdAt?: string; updatedAt?: string; lastValidatedAt?: string; tasks: SecretTaskUsage[]; canDelete: boolean }
...
export type Task = { id: string; name: string; enabled?: boolean; isDeleted?: boolean; state?: string; activeVersion?: number; pool?: string; pinnedRunner?: string; command?: string[]; workingDirectory?: string; placementSelectors?: Record<string, unknown>; environment?: Record<string, string>; secretReferences?: Record<string, string>; durationSeconds?: number; maxAttempts?: number; ambiguityPolicy?: string; resources?: string[]; latestRun?: Run }
