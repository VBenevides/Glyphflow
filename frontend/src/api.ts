...
export type Task = { id: string; name: string; enabled?: boolean; state?: string; activeVersion?: number; pool?: string; pinnedRunner?: string; timeoutSeconds?: number; latestRun?: Run }
