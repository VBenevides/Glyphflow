...
export type Run = { id: string; taskId?: string; taskName?: string; state: string; placementBlocker?: string; attempt?: number; exitCode?: number; exitCodeMeaning?: string; error?: string; runner?: string; trigger?: string; scheduledFor?: string; duration?: number; attempts?: RunAttempt[]; events?: RunEvent[]; sessions?: RunSession[]; leases?: RunLease[]; cancellation?: RunCancellation; logGaps?: RunLogGap[] }
