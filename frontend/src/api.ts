...
export type Run = { id: string; taskId?: string; taskName?: string; state: string; placementBlocker?: string; attempt?: number; exitCode?: number; exitCodeMeaning?: string; runner?: string; trigger?: string; scheduledFor?: string; duration?: number; attempts?: RunAttempt[]; events?: RunEvent[]; sessions?: RunSession[]; leases?: RunLease[]; cancellation?: RunCancellation; logGaps?: RunLogGap[] }
export type ExitCode = { code: number; meaning: string; isSystem?: boolean }
export type Runner = { id: string; name: string; poolId?: string; desiredState?: string; observedState?: string; pool?: string; capacity?: number; currentCapacity?: number; activeCount?: number; heartbeatAt?: string; platform?: string; architecture?: string; natsEndpoint?: string; isArchived?: boolean; isDeleted?: boolean }
