...
export type Run = { id: string; taskId?: string; taskName?: string; state: string; attempt?: number; exitCode?: number; exitCodeMeaning?: string; runner?: string; trigger?: string; scheduledFor?: string; duration?: number }
