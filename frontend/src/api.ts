...
export type AuditEvent = { id: string; actor?: string; actorName?: string; actorEmail?: string; action?: string; target?: string; result?: string; createdAt?: string; correlationId?: string; before?: unknown; after?: unknown }
