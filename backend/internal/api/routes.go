...
var routeDefinitions = []RouteDefinition{
	...
	{Pattern: "/api/v1/tasks", Access: RoutePermission, Permission: permissionTaskReadManage},
	{Pattern: "/api/v1/schedules", Access: RoutePermission, Permission: permissionTaskReadManage},
	...
	{Pattern: "/api/v1/global-variables", Access: RoutePermission, Permission: permissionUsersManage},
	{Pattern: "/api/v1/global-variables/", Access: RoutePermission, Permission: permissionUsersManage},
	{Pattern: "/api/v1/schedules/", Access: RoutePermission, Permission: permissionTaskReadManage},
	{Pattern: "/api/v1/tasks/", Access: RoutePermission, Permission: permissionTaskReadManage},
	...
	{Pattern: "/api/v1/runners/pools", Access: RoutePermission, Permission: permissionRunnersReadManage},
	{Pattern: "/api/v1/runners/pools/", Access: RoutePermission, Permission: permissionRunnersReadManage},
	{Pattern: "/api/v1/runners/", Access: RoutePermission, Permission: permissionRunnersReadManage},
	{Pattern: "/api/v1/runs/", Access: RoutePermission, Permission: "runs.read|runs.cancel|runs.retry|logs.read"},
	{Pattern: "/api/v1/users", Access: RoutePermission, Permission: permissionUsersReadManage},
	{Pattern: "/api/v1/users/", Access: RoutePermission, Permission: permissionUsersReadManage},
	...
	{Pattern: "/api/v1/admin/system/metrics", Access: RoutePermission, Permission: "system.metrics.read"},
	{Pattern: "/api/v1/admin/secrets/attention", Access: RoutePermission, Permission: "secrets.read|secrets.manage"},
	{Pattern: "/api/v1/admin/secrets", Access: RoutePermission, Permission: "secrets.read|secrets.manage"},
	{Pattern: "/api/v1/admin/secrets/", Access: RoutePermission, Permission: "secrets.manage"},
	{Pattern: "/api/v1/admin/dead-letters", Access: RoutePermission, Permission: "system.deadletter.read|system.deadletter.manage"},
	{Pattern: "/api/v1/admin/dead-letters/", Access: RoutePermission, Permission: "system.deadletter.read|system.deadletter.manage"},
	{Pattern: "/api/v1/admin/auth/settings", Access: RoutePermission, Permission: permissionAuthSettingsManage},
	{Pattern: "/api/v1/admin/execution-status", Access: RoutePermission, Permission: permissionAuthSettingsManage},
	{Pattern: "/api/v1/admin/execution-status/", Access: RoutePermission, Permission: permissionAuthSettingsManage},
	{Pattern: "/api/v1/admin/auth/sessions/revoke", Access: RoutePermission, Permission: permissionUsersManage},
	{Pattern: "/api/v1/admin/auth/sessions", Access: RoutePermission, Permission: permissionUsersReadManage},
	{Pattern: "/api/v1/admin/auth/providers", Access: RoutePermission, Permission: "sso.manage"},
	{Pattern: "/api/v1/admin/auth/users/", Access: RoutePermission, Permission: permissionUsersManage},
