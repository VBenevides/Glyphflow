...
func (s Server) passwordRoutes(mux routeRegistrar) {
	if s.AuthService != nil {
		mux.HandleFunc("/api/v1/auth/register", s.registerWithAuthService)
		mux.HandleFunc("/api/v1/auth/login", s.loginWithAuthService)
		mux.HandleFunc("/api/v1/auth/refresh", s.refreshAuthService)
		mux.HandleFunc("/api/v1/auth/logout", s.logoutAuthService)
		mux.HandleFunc("/api/v1/auth/logout-all", s.logoutAllAuthService)
		return
	}
	if s.PasswordAuth == nil {
		return
	}
	mux.HandleFunc("/api/v1/auth/register", s.registerWithPasswordAuth)
	mux.HandleFunc("/api/v1/auth/login", s.loginWithPasswordAuth)
}

func (s Server) registerWithAuthService(w http.ResponseWriter, r *http.Request) {
...
func (s Server) loginWithAuthService(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		writeJSON(w, 405, map[string]string{"error": errorMethodNotAllowed})
		return
	}
...
func (s Server) refreshAuthService(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		writeJSON(w, 405, map[string]string{"error": errorMethodNotAllowed})
		return
	}
...
func (s Server) logoutAuthService(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		writeJSON(w, 405, map[string]string{"error": errorMethodNotAllowed})
		return
	}
...
func (s Server) logoutAllAuthService(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		writeJSON(w, 405, map[string]string{"error": errorMethodNotAllowed})
		return
	}
...
func (s Server) registerWithPasswordAuth(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		writeJSON(w, 405, map[string]string{"error": errorMethodNotAllowed})
		return
	}
...
func (s Server) loginWithPasswordAuth(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		writeJSON(w, 405, map[string]string{"error": errorMethodNotAllowed})
		return
	}
