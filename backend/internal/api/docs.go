...
const openAPISpec = `{
  ...
  "paths": {
    ...
    "/api/v1/tasks/{task_id}": {"get": {"tags": ["Tasks"], "summary": "Get a task", "security": [{"bearerAuth": []}], "responses": {"200": {"description": "Task"}, "404": {"description": "Not found"}}}, "delete": {"tags": ["Tasks"], "summary": "Permanently delete a task", "security": [{"bearerAuth": []}], "responses": {"204": {"description": "Deleted"}, "404": {"description": "Not found"}, "409": {"description": "Task is referenced by execution history"}}}},
    ...
    "/api/v1/resources": {"get": {"tags": ["Operations"], "summary": "List resources", "security": [{"bearerAuth": []}], "responses": {"200": {"description": "Resource page"}}}, "post": {"tags": ["Operations"], "summary": "Create a resource", "security": [{"bearerAuth": []}], "requestBody": {"required": true, "content": {"application/json": {"schema": {"type": "object", "required": ["name"], "properties": {"name": {"type": "string"}, "kind": {"type": "string", "default": "exclusive"}}}}}}, "responses": {"201": {"description": "Resource created"}, "400": {"description": "Invalid resource"}}}},
