...
const openAPISpec = `{
  ...
  "paths": {
    ...
    "/api/v1/users": {"get": {"tags": ["Administration"], "summary": "List users", "security": [{"bearerAuth": []}], "parameters": [{"name": "email", "in": "query", "schema": {"type": "string"}}, {"name": "status", "in": "query", "schema": {"type": "string", "enum": ["active", "pending", "disabled"]}}, {"name": "page", "in": "query", "schema": {"type": "integer"}}, {"name": "limit", "in": "query", "schema": {"type": "integer"}}], "responses": {"200": {"description": "User page"}}}, "post": {"tags": ["Administration"], "summary": "Create a user", "security": [{"bearerAuth": []}], "responses": {"201": {"description": "Created"}}}},
